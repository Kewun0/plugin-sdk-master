...
CMatrix::CMatrix(CMatrix const& src) {
    ((void(__thiscall *)(CMatrix*, CMatrix const&))0x4B8E60)(this, src);
}
...
CMatrix::CMatrix(RwMatrixTag* rwMatrix, bool deleteOnDetach) {
    ((void(__thiscall *)(CMatrix*, RwMatrixTag*, bool))0x4B8E80)(this, rwMatrix, deleteOnDetach);
}
...
CMatrix::~CMatrix() {
    ((void(__thiscall *)(CMatrix*))0x4B8EA0)(this);
}
...
CMatrix operator*(CMatrix const& a, CMatrix const& b) {
    CMatrix result;
    ((void(__cdecl *)(CMatrix*, CMatrix const&, CMatrix const&))0x4B9E50)(&result, a, b);
    return result;
}
...
CVector operator*(CMatrix const& m, CVector const& v) {
    CVector result;
    ((void(__cdecl *)(CVector*, CMatrix const&, CVector const&))0x4BA5C0)(&result, m, v);
    return result;
}
