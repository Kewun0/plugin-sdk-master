...
float FindPlayerHeading() {
    return plugin::CallAndReturn<float, 0x4A1310>();
}
...
CPlayerPed* FindPlayerPed() {
    return plugin::CallAndReturn<CPlayerPed*, 0x4A1240>();
}
...
CVehicle* FindPlayerVehicle() {
    return plugin::CallAndReturn<CVehicle*, 0x4A11B0>();
}
...
CVector& FindPlayerCoors() {
    return plugin::CallAndReturn<CVector&, 0x4A1120>();
}
