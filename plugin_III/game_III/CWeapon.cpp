...
void CWeapon::DoDriveByAutoAiming(CEntity* pFiringEntity, CVector* start, CVector* end) {
    plugin::Call<0x563790, CEntity*, CVector*, CVector*>(pFiringEntity, start, end);
}
...
bool CWeapon::FireSniper(CEntity* pFiringEntity) {
    return plugin::CallMethodAndReturn<bool, 0x562110, CWeapon *, CEntity*>(this, pFiringEntity);
}
